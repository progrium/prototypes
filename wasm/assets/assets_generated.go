...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2018, 10, 11, 17, 13, 18, 568372182, time.UTC),
		},
		"/app": &vfsgen۰DirInfo{
			name:    "app",
		...
		"/pkg": &vfsgen۰DirInfo{
			name:    "pkg",
			modTime: time.Date(2018, 10, 11, 17, 13, 18, 568372135, time.UTC),
		},
		"/pkg/webui": &vfsgen۰DirInfo{
			name:    "webui",
			modTime: time.Date(2018, 10, 11, 17, 13, 24, 807756374, time.UTC),
		},
		"/static": &vfsgen۰DirInfo{
			name:    "static",
			modTime: time.Date(2018, 10, 11, 18, 49, 57, 340571580, time.UTC),
		},
	...
	fs["/pkg"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		fs["/pkg/webui"].(os.FileInfo),
	}
