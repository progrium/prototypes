...
func (ti *TypeInfo) Kind() reflect.Kind {
	...
	case '@', '#', '*', ':':
		return reflect.Uintptr
	default:
		panic("unsupported type: " + ti.Code)
	}
}

func (ti *TypeInfo) String() string {
	return strings.ToLower(ti.Kind().String())
}
...
func LoadSignatures(filepath string) (*Signatures, error) {
